...
def transform(df, *args, **kwargs):
    ...
    datetime_dim= datetime_dim[['datetime_id','tpep_pickup_datetime','pick_hour','pick_day','pick_month','pick_year','pick_weekday','tpep_dropoff_datetime','dropoff_hour','dropoff_day','dropoff_month','dropoff_year','dropoff_weekday']]
    ...
    return  {"datatime_dim":datetime_dim.to_dict(orient= "dict"),
